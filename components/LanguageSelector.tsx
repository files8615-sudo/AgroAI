    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-100 rounded-xl shadow-xl z-50 overflow-hidden py-1 max-h-80 overflow-y-auto animate-fade-in">
            {(Object.keys(LANGUAGE_NAMES) as Language[]).map((lang) => (
              <button
                ...
                className={`w-full text-left px-4 py-2.5 text-sm flex items-center justify-between hover:bg-agro-50 transition-colors ${
